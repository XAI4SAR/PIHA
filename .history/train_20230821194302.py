...
if __name__ == '__main__': 
    ...
    parser.add_argument('--datatxt_OFA1', default='')
    parser.add_argument('--datatxt_OFA2', default=datatxt_test_SOC14)
    parser.add_argument('--datatxt_OFA3', default=datatxt_test_EOCdepression)
