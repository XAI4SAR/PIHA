...
class DenseNet_PIHA(nn.Module):
    ...
    def __init__(self, growth_rate=32, block_config=(6, 12, 24, 16),
        ...
        super(DenseNet_PIHA, self).__init__()
        ...
        for i, num_layers in enumerate(block_config):
            ...
            if attention_setting:
                self.phy_attn_a.append(PIHA(part_num, num_features, pow(2, i+2), reduction=2))
...
def _densenet_PIHA(growth_rate, block_config, num_init_features, num_classes, **kwargs):
    model = DenseNet_PIHA(growth_rate, block_config, num_init_features, num_classes=num_classes, **kwargs)
    
    return model


def densenet121_PIHA(num_class, **kwargs):

    return _densenet_PIHA(32, (6, 12, 24, 16), 64, num_class, **kwargs)