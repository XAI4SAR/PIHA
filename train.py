...
def parameter_setting(args):
    ...
    config['datatxt_test_SOC10'] = args.datatxt_test_SOC10
    config['datatxt_test_SOC14'] = args.datatxt_test_SOC14
    config['datatxt_test_EOCdepression'] = args.datatxt_test_EOCdepression
...
def train(config, i):
    ...
    early_stopping = EarlyStopping(os.path.join(save_path, '{}.pth'.format(i)), config['patience'])
...
if __name__ == '__main__': 
    ...
    parser.add_argument('--datatxt_train', default=datatxt_train)
    parser.add_argument('--datatxt_test_SOC10', default=datatxt_test_SOC10)
    parser.add_argument('--datatxt_test_SOC14', default=datatxt_test_SOC14)
    parser.add_argument('--datatxt_test_EOCdepression', default=datatxt_test_EOCdepression)
    parser.add_argument('--datatxt_val', default=datatxt_val)
    parser.add_argument('--cate_num', type=int, default=cate_num)
    parser.add_argument('--save_path', default=save_path) 
    parser.add_argument('--pretrain', default=pretrain)
    # training setting
    parser.add_argument('--batch_size', type=int, nargs='+', default=32)

    parser.add_argument('--num_epochs', type=int, default=1000)

    parser.add_argument('--part_num', type=int, default=part_num)

    parser.add_argument('--patience', type=int, default=patience)
    parser.add_argument('--attention_setting', default=attention_setting)
    ...
    for i in range(train_nums):
        ...
        SOC10_result = 'SOC10:' + '\t'.join(SOC10_list) + '\n'
        SOC14_result = 'SOC14:' + '\t'.join(SOC14_list) + '\n'
        EOCdepression_result = 'EOCdepression:' + '\t'.join(EOCdepression_list) + '\n'
